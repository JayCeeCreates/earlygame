...
public class ItemsInit {
    ...
    public static void init() {
        ...
        // copper
        register("copper_ore", new BlockItem(BlocksInit.COPPER_ORE, new Item.Settings().group(ModItemGroup.EARLYGAME)));
        register("copper_block", new BlockItem(BlocksInit.COPPER_BLOCK, new Item.Settings().group(ModItemGroup.EARLYGAME)));
    ...
    static {
        ...
        // copper
        COPPER_INGOT = new Item(new Item.Settings().group(ModItemGroup.EARLYGAME));
